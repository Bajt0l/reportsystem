...
TriggerEvent('chat:addSuggestion', '/zglos', 'Napisz Report', {
    { name="title", help="Tytuł Zgłoszenia" },
    { name="message", help="Opisz problem" }
})

TriggerEvent('chat:addSuggestion', '/zgloszenia', 'sprawdz zgloszenia')
